Description :
=============
I just shared my works, which I worked as learning path and practiced some C programming such as to calculate absolute difference between the sums of its diagonals for a given a square matrix. 
